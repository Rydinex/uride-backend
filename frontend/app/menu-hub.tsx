...
export default function DriverMenuHubScreen() {
              ...
              >
                ...
                {expandedSection === section.id && (
                  <View style={[styles.expandedContent, { borderTopColor: colors.border }]}>
                    ...
                    <Pressable
                      onPress={() => {
                        // Navigate to section detail screens
                        if (section.id === 'work-hub') router.push('/(driver)/earnings');
                        else if (section.id === 'opportunities') router.push('/(driver)/surge-map');
                        else if (section.id === 'pro-status') router.push('/(driver)/professional-profile');
                        else if (section.id === 'refer-friend') router.push('/(driver)/account');
                        else if (section.id === 'vehicle') router.push('/(driver)/professional-profile');
                        else if (section.id === 'documents') router.push('/(driver)/professional-profile');
                        else if (section.id === 'tax') router.push('/(driver)/earnings');
                        else if (section.id === 'help') router.push('/(driver)/account');
                        else if (section.id === 'safety') router.push('/(driver)/account');
                        else if (section.id === 'settings') router.push('/(driver)/account');
                      }}
                      style={({ pressed }) => [
                        styles.actionButton,
                        { opacity: pressed ? 0.7 : 1 },
